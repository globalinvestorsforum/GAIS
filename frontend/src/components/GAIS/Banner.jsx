...
const Banner = () => {
  return (
    ...
    >
      <div className="absolute flex  flex-col justify-center items-start  lg:px-44 md:px-20 px-5 w-full h-full text-start  backdrop-blur-[1px] backdrop-brightness-50">
        <p className="md:text-xl mx-auto w-full  ">
        ...
        <p className="pt-10  md:text-xl mx-auto  w-full ">
