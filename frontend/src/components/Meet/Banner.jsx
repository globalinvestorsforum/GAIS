...
const Banner = () => {
  return (
    ...
    >
      <div className="flex absolute flex-col justify-center items-center px-4 w-full h-full text-start left-0 backdrop-blur-[1px] backdrop-brightness-50">
        <p className="md:text-2xl lg:text-2xl text-xl mx-auto  ">
        ...
        <p className="mt-2  md:w-2/3 sm:w-full p-3 md:text-[18px] text-neutral-200 mx-auto ">
          ...
          Secure your spot and unlock the immense potential of the world's most
